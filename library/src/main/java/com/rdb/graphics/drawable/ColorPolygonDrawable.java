...
/**
 * Created by DB on 2017/8/17.
 */

public class ColorPolygonDrawable extends ColorShapeDrawable {
    ...
    public ColorPolygonDrawable(@NonNull ColorStateList colorStateList, int sideCount, float startDegree) {
        super(colorStateList);
        init(sideCount, startDegree);
    }

    public ColorPolygonDrawable(@NonNull ColorStateList colorStateList, float strokeWidth, ColorStateList strokeColorStateList, int sideCount, float startDegree) {
